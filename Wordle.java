...
class Wordle
{
    ...
    Wordle()
    {
        ...
        word = Main.readFile("WordBank.txt", srand.nextInt(length), length).toLowerCase(); // Add random word to list
    }
    ...
    */
    private int binarySearch(int lower, int higher) // Binary Search algorithm to improve runtime Complexity
    {
        ...
        String read = Main.readFile("WordBank.txt", mid, length).toLowerCase();
